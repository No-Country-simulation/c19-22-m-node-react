...
import colorPicker from '../../assets/iconoColorPicker.png'
...
export const PublishPic = () => {
    return (
        <section className='publish'>
            <div className="h-[375px] w-[375px] mt-6 py-4">
                <img className="w-full h-full" src={imagePost} alt="" />
            </div>
            ...
            <div className="icons flex gap-4 items-center justify-center py-4">
                ...
                <button className="text text-custom-gray border border-gray-300 bg-custom-light-gray shadow-md rounded-[6px] p-3"><PiTextT className="h-[24px] w-[24px]"/>
                </button>
            </div>
            <div>
