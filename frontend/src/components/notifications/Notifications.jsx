  ...
  return (
      <section className='notifications'>
        ...
        <div className="shadow-up-dark-md">
          ...
          <div className="fila-usuario2 py-2 px-4 flex justify-between items-center">
              <div className="profilepic-nombre flex gap-2 items-center">
                <div className="para-recortar-foto w-[44px] h-[44px] overflow-hidden rounded-full">
                    <img className='w-full h-full object-cover' src={user2} alt="" />
                </div>
                <p className="font-semibold text-sm">sim.her</p>
              </div>
              <div className="para-recortar-foto w-[44px] h-[44px] overflow-hidden rounded-lg">
                    <img className='w-full h-full object-cover' src={imagePost} alt="" />
              </div>              
          </div>
