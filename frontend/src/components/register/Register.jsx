            ...
            <form className=" p-6 pt-6 pb-6 rounded-lg w-full max-w-sm">
                ...
                <div className="mb-4">
                    ...
                    <input onChange={(e) => setUsername(e.target.value)}
                        ...
                        className="w-full px-4 py-1 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primario focus:border-transparent border-gray-300"
                    />
                    <p className="text-xs text-custom-gray-80 pt-1">Podrás modificarlo después.</p>
                </div>
                <div className="mb-4">
                    ...
                    <input onChange={(e) => setPassword(e.target.value)}
                        ...
                        className="w-full px-4 py-1 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primario focus:border-transparent border-gray-300"
                    />                    
                    <p className="text-xs text-custom-gray-80 pt-1">Debe contener al menos 8 caracteres e incluir 1 número.</p>
                </div>
                ...
                <div className="mb-12">
                    ...
                    <input onChange={(e) => setRepeatP(e.target.value)}
                        type="password"
                        id="repeatPassword"
                        name="repeatPassword"
                        placeholder="********"
                ...
                {password !== null && password !== "" && (
                    errorP ? 
                        <p className="text-custom-errores text-xs pt-1">Las contraseñas no coinciden</p> :
                        <p className="text-green-700 text-xs pt-1">Las contraseñas coinciden</p>
                )}
                
                </div>
                <button onClick={enviar} type="submit" id="registrarme" className="w-full py-2 px-4 bg-primario text-white rounded-lg hover:bg-primario-hover focus:outline-none focus:bg-primario-hover">
                 Registrarme
                </button>
            </form>     
                
            <p className="text-center text-xs pb-6">Ya tienes una cuenta? <a href="#" className="text-secundario font-semibold">INICIA SESION</a></p>                       
        </section>
    )
  }