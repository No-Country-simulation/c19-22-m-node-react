        ...
        <section className='login h-[640px] flex flex-col gap-12 items-center justify-center'>
            ...
            <div className="w-full max-w-sm">
                <form className="bg-white p-6 pt-2 pb-3 rounded-lg mb-4">
                    <div className="mb-4">
                        <label htmlFor="email-username" className="block text-base text-gray-700 font-semibold mb-0">
                            Email o Usuario
                        </label>
                ...
                <p className="text-center text-sm">No tienes una cuenta? <a href="#" className="text-secundario font-semibold">REGISTRATE</a></p>
